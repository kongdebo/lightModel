...
const Foam::word
Foam::light::lightIntensityRay::intensityPrefix("ILambda");
...
:
    ...
    (
        ...
        mesh_,
        dimensionedScalar("I", dimLuminousIntensity, 0.0)         
    ),
...
void Foam::light::lightIntensityRay::addIntensity()
{
  //  I_ = dimensionedScalar("zero", dimMass/pow3(dimTime), 0.0);dimLuminousIntensity
  
     I_ = dimensionedScalar("zero", dimLuminousIntensity, 0.0);
    forAll(ILambda_, lambdaI)
    {
